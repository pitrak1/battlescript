...
public static class VariablesAndOperatorsTests
{
    ...
    public class VariableTypes
    {
        ...
        public void SupportsFloats()
        {
            var input = "x = 5.5";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Float, 5.5);
        ...
        public void SupportsBooleans()
        {
            var input = "x = True";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Bool, 1);
        ...
        public void SupportsClasses()
        {
            ...
            {
                {"y", BsTypes.Create(memory, BsTypes.Types.Int, 3)}
            });
    ...
    public class AssignmentOperators
    {
        ...
        public void SupportsSubtractAssignment()
        {
            var input = "x = 5\nx -= 5";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Int, 0);
        ...
        public void SupportsMultiplyAssignment()
        {
            var input = "x = 5\nx *= 5";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Int, 25);
        ...
        public void SupportsTrueDivisionAssignment()
        {
            var input = "x = 8\nx /= 5";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Float, 1.6);
        ...
        public void SupportsFloorDivisionAssignment()
        {
            var input = "x = 8\nx //= 5";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Int, 1);
        ...
        public void SupportsPowerAssignment()
        {
            var input = "x = 9\nx **= 2";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Int, 81);
    ...
    public class OperatorPrecedence
    {
        ...
        public void ValuesPowerOverDivisionMultiplicationAndModulo()
        {
            var input = "x = 4 * 2 ** 3";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Int, 32);
    ...
    public class ResultType
    {
        ...
        public void UnaryOperatorsReturnFloatIfGivenFloat()
        {
            var input = "x = -1.0";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Float, -1.0);
        ...
        public void TrueDivisionAlwaysReturnsAFloat()
        {
            var input = "x = 12/3";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Float, 4.0);
        ...
        public void OtherOperatorsReturnIntegerIfBothOperandsAreIntegers()
        {
            var input = "x = 12 * 3";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Int, 36);
        ...
        public void OtherOperatorsReturnFloatIfBothOperandsAreFloats()
        {
            var input = "x = 2.5 * 4.0";
            var memory = Runner.Run(input);
            var expected = BsTypes.Create(memory, BsTypes.Types.Float, 10.0);
