...
[TestFixture]
public static class SpecialVariableInstructionTests
{
    [TestFixture]
    public class Constructor
    {
        ...
        public void SingleAsterisk()
        {
            ...
            var result = new SpecialVariableInstruction(tokens);
        ...
        [Test]
        public void ThrowsExceptionForMultipleTokens()
        {
            var tokens = new List<Token>
            {
                new(Consts.TokenTypes.SpecialVariable, "*args"),
                new(Consts.TokenTypes.SpecialVariable, "*extra")
            };

            Assert.Throws<Exception>(() => new SpecialVariableInstruction(tokens));
        }
    }
}
