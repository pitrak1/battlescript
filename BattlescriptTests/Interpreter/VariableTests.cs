    ...
    public class GetItem
    {
        ...
        public void GetsItemFromList()
        {
            var memory = Runner.Run("""
                                    ...
                                    y = x[1]
                                    """);
            var expected = memory.Create(Memory.BsTypes.Int, 2);
        ...
        public void GetsItemWithStringKeyFromDictionary()
        {
            var memory = Runner.Run("""
                                    ...
                                    y = x["zxcv"]
                                    """);
            var expected = memory.Create(Memory.BsTypes.String, "qwer");
            Assertions.AssertVariable(memory, "y", expected);
        }
    ...
    public class SetItem
    {
        ...
        public void SetsItemWithNumericKeyInDictionary()
        {
            var memory = Runner.Run("""
                                    ...
                                    y = x[1]
                                    """);
            var expected = memory.Create(Memory.BsTypes.String, "zxcv");
            Assertions.AssertVariable(memory, "y", expected);
        }
