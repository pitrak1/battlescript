...
public static class ListVariableTests
{
    ...
    //             new NumericVariable(8)
    //         ]);
    //         var index = new List<Variable>() { null, BuiltInTypeHelper.CreateBuiltInTypeWithValue(Runner.Run(""), "int", 2) };
    //         var memory = Runner.Run("");
    //         var result = listVariable.GetRangeIndex(memory, index);
    //         var expected = new ListVariable([
    //             new NumericVariable(5),
    ...
    //             new NumericVariable(8)
    //         ]);
    //         var index = new List<Variable>() { BuiltInTypeHelper.CreateBuiltInTypeWithValue(Runner.Run(""), "int", 1), null };
    //         var memory = Runner.Run("");
    //         var result = listVariable.GetRangeIndex(memory, index);
    //         var expected = new ListVariable([
    //             new StringVariable("a"),
    ...
    //             new NumericVariable(8)
    //         ]);
    //         var index = new List<Variable>() { null, null };
    //         var memory = Runner.Run("");
    //         var result = listVariable.GetRangeIndex(memory, index);
    //         var expected = new ListVariable([
    //             new NumericVariable(5),
    ...
    //             new NumericVariable(8)
    //         ]);
    //         var index = new List<Variable>() { null, null, BuiltInTypeHelper.CreateBuiltInTypeWithValue(Runner.Run(""), "int", -1) };
    //         var memory = Runner.Run("");
    //         var result = listVariable.GetRangeIndex(memory, index);
    //         var expected = new ListVariable([
    //             new NumericVariable(8),
